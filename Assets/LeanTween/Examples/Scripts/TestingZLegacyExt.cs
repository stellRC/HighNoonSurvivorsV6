...
public class TestingZLegacyExt : MonoBehaviour
{
    ...
    void cycleThroughExamples()
    {
        if (exampleIter == 0)
        {
            ...
            {
                descrTimeScaleChangeId = gameObject
                    .LeanValue(0.01f, 10.0f, 3f)
                    .setOnUpdate(
                        (float val) =>
                        {
        ...
        gameObject
            .LeanDelayedCall(delayTime, cycleThroughExamples)
    ...
    public void colorExample()
    {
        ...
        lChar
            .LeanColor(new Color(1.0f, 0.0f, 0.0f, 0.5f), 0.5f)
    ...
    public void rotateExample()
    {
        ...
        ltLogo
            .LeanRotate(new Vector3(0f, 360f, 0f), 1f)
            .setEase(LeanTweenType.easeOutQuad)
    ...
    public void moveLocalExample()
    {
        ...
        lChar
            .LeanMoveLocal(new Vector3(0.0f, 2.0f, 0.0f), 0.5f)
            .setUseEstimatedTime(useEstimatedTime);
