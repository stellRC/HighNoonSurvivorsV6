...
namespace DentedPixel.LTExamples
{
    public class TestingUnitTests : MonoBehaviour
    {
        ...
        private bool eventGameObjectWasCalled = false,
        ...
        void Start()
        {
            ...
            LeanTest.expect(
                LeanTween.isTweening(cube1) == false,
                "OBJECT NOT TWEEENING AT BEGINNING"
            );
            ...
            LeanTest.expect(
                LeanTween.removeListener(cube2, 0, eventGameObjectCalled) == false,
                "EVENT GAMEOBJECT NOT REMOVED"
            );
            // remove listener
            LeanTest.expect(
                LeanTween.removeListener(cube1, 0, eventGameObjectCalled),
            ...
            LeanTest.expect(
                (Vector3.Distance(cube4.transform.position, new Vector3(10f, 0f, 0f)) <= 0.7f),
            ...
            LeanTween
                .move(cubeToTrans, cubeDest.transform, 1.2f)
                .setEase(LeanTweenType.easeOutQuad)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeToTrans.transform.position == cubeDestEnd,
                        "MOVE TO TRANSFORM WORKS"
                    );
                });
            ...
            LeanTween
                ...
                {
                    LeanTest.expect(
                        Vector3.Distance(new Vector3(1f, 0f, 1f), cubeSpline.transform.position)
                            < 0.01f,
            ...
            LeanTween
                .scale(cubeScale, new Vector3(5f, 5f, 5f), 0.01f)
                .setOnStart(() =>
                {
                ...
                {
                    LeanTest.expect(
                        cubeScale.transform.localScale.z == 5f,
                        "SCALE",
            ...
            LeanTween
                .rotate(cubeRotate, new Vector3(0f, 180f, 0f), 0.02f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeRotate.transform.eulerAngles.y == 180f,
                        "ROTATE",
                        "expected rotate y:"
                            + 180f
                            + " returned:"
            ...
            LeanTween
                .rotateAround(cubeRotateA, Vector3.forward, 90f, 0.3f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeRotateA.transform.eulerAngles.z == 90f,
                        "ROTATE AROUND",
                        "expected rotate z:"
                            + 90f
                            + " returned:"
            ...
            LeanTween
                .rotateAround(cubeRotateB, Vector3.forward, 360f, 0.3f)
                .setPoint(new Vector3(5f, 3f, 2f))
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeRotateB.transform.position.ToString()
                            == (new Vector3(200f, 10f, 8f)).ToString(),
                        "ROTATE AROUND 360",
                        "expected rotate pos:"
            ...
            LeanTween
                ...
                .setOnComplete(
                    (object completeObj) =>
                    {
                        ...
                        LeanTest.expect(
                            cubeAlpha1.GetComponent<Renderer>().material.color.a == 0.5f,
                            "ALPHA"
                        );
                    }
                );
            ...
            LeanTween
                .color(cubeAlpha2, Color.cyan, 0.3f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeAlpha2.GetComponent<Renderer>().material.color == Color.cyan,
                        "COLOR"
                    );
                    LeanTest.expect(
                        onStartTime >= 0f && onStartTime < Time.time,
                        "ON START",
            ...
            LeanTween
                .moveY(cubeAlpha1, 3f, 0.2f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeAlpha1.transform.position.x == beforePos.x
                            && cubeAlpha1.transform.position.z == beforePos.z,
                        "MOVE Y"
                    );
                });
            ...
            LeanTween
                .moveLocalZ(cubeAlpha2, 12f, 0.2f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeAlpha2.transform.localPosition.x == beforePos2.x
                            && cubeAlpha2.transform.localPosition.y == beforePos2.y,
                        "MOVE LOCAL Z",
                        "ax:"
                            + cubeAlpha2.transform.localPosition.x
                            + " bx:"
                            + beforePos.x
                            + " ay:"
                            + cubeAlpha2.transform.localPosition.y
                            + " by:"
                            + beforePos2.y
                    );
                });

            AudioClip audioClip = LeanAudio.createAudio(
            ...
            LeanTween
                .delayedSound(gameObject, audioClip, new Vector3(0f, 0f, 0f), 0.1f)
                .setDelay(0.2f)
                .setOnComplete(() =>
                {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                for (int i = (int)LeanTweenType.notUsed; i < totalTweenTypeLength; i++)
                {
                    ...
                    LTDescr descr = LeanTween
                        .moveLocalX(cube, 5, 0.1f)
                        .setOnComplete(
                            (object obj) =>
                            {
                                ...
                                {
                                    LeanTest.expect(
                                        totalEasingCheck == totalEasingCheckSuccess,
                                        "EASING TYPES"
                                    );
                                }
                            }
            ...
            LeanTween
                .value(gameObject, new Vector2(0, 0), new Vector2(256, 96), 0.1f)
                .setOnUpdate(
                    (Vector2 value) =>
                    {
        ...
        IEnumerator timeBasedTesting()
        {
            ...
            LeanTest.expect(
                descr.Length >= 0 && descr[0].to.x == 12f,
                "WE CAN RETRIEVE A DESCRIPTION"
            );

            GameObject cubeIgnore = cubeNamed("ignoreTimeScale");
            LeanTween
                .moveX(cubeIgnore, 5f, 1.5f)
            ...
            LeanTest.expect(
                Mathf.Abs(timeElapsedNormalTimeScale - timeElapsedIgnoreTimeScale) < 0.7f,
                "START IGNORE TIMING",
            ...
            LeanTween
                .moveLocal(cubeRound, roundCirc, 0.5f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cubeRound.transform.position == onStartPos,
            ...
            LeanTween
                .moveSplineLocal(cubeSpline, roundSpline, 0.5f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        Vector3.Distance(onStartPosSpline, cubeSpline.transform.position) <= 0.01f,
            ...
            seq.append(() =>
                {
                    LeanTest.expect(
                        cubeSeq.transform.position.x == 100f,
                        "SEQ MOVE X FINISHED",
                        "move x:" + cubeSeq.transform.position.x
                    );
                    LeanTest.expect(
                        cubeSeq.transform.localScale.x == 2f,
                        "SEQ SCALE X FINISHED",
            ...
            LeanTween
                .move(cubeBounds, new Vector3(10, 10, 10), 0.1f)
                .setOnUpdate(
                    (float val) =>
                    {
                        ...
                        if (
                            cubeBounds.transform.position.x < 0f
                            || cubeBounds.transform.position.x > 10f
                            || cubeBounds.transform.position.y < 0f
                            || cubeBounds.transform.position.y > 10f
                            || cubeBounds.transform.position.z < 0f
                            || cubeBounds.transform.position.z > 10f
                        )
                        {
                            didPassBounds = false;
            ...
            for (int i = 0; i < groupTweens.Length; i++)
            {
                ...
                groupTweens[i] = LeanTween
                    .move(groupGOs[i], finalPos, 3f)
                    .setOnStart(() =>
                    {
                        setOnStartNum++;
                    })
                    ...
                    .setOnComplete(
                        (object param) =>
                        {
                            Dictionary<string, object> finalDictRetr =
                            ...
                            if (hasGroupTweensCheckStarted == false)
                            {
                                ...
                                LeanTween.delayedCall(
                                    ...
                                    {
                                        LeanTest.expect(
                                            setOnStartNum == groupTweens.Length,
                                            "SETONSTART CALLS",
                                            "expected:"
                                                + groupTweens.Length
                                                + " was:"
                                        ...
                                        LeanTest.expect(
                                            groupTweensCnt == groupTweens.Length,
                                            "GROUP FINISH",
                                            "expected "
                                                + groupTweens.Length
                                                + " tweens but got "
            ...
            LeanTest.expect(
                LeanTween.maxSearch <= expectedSearch,
                "MAX SEARCH OPTIMIZED",
            ...
            lt4 = LeanTween
                .moveX(cube4, 5.0f, 1.1f)
                .setOnComplete(() =>
                {
                    LeanTest.expect(
                        cube4 != null && previousXlt4 != cube4.transform.position.x,
                        "RESUME OUT OF ORDER",
                        "cube4:"
                            + cube4
                            + " previousXlt4:"
            ...
            LeanTween
                .rotateAround(cube3, Vector3.forward, 360f, 0.1f)
                .setRepeat(3)
                .setOnComplete(rotateRepeatFinished)
            ...
            LeanTest.expect(
                ...
                "CANCEL AFTER RESET SHOULD FAIL",
            ...
            for (int i = 0; i < groupTweens.Length; i++)
            {
                ...
                if (
                    i % 2 == 0
                        ? LeanTween.isTweening(groupTweens[i].id)
                        : LeanTween.isTweening(groupGOs[i])
                )
                    tweenCount++;
            }
            ...
            LeanTest.expect(
                pauseCount == 0,
                "ON UPDATE NOT CALLED DURING PAUSE",
            ...
            LeanTween
                ...
                .setOnComplete(() =>
                {
                    ...
                    LeanTest.expect(
                        Mathf.Abs(expectedTime - diff) < 0.06f,
                        "SCALED TIMING DIFFERENCE",
                    ...
                    LeanTest.expect(
                        Mathf.Approximately(cube1.transform.position.x, -5f),
                        "SCALED ENDING POSITION",
            ...
            LeanTween
                .value(gameObject, new Vector3(1f, 1f, 1f), new Vector3(10f, 10f, 10f), 1f)
                .setOnUpdate(
                    (Vector3 val) =>
                    {
        ...
        IEnumerator lotsOfCancels()
        {
            ...
            for (int i = 0; i < aGOs.Length; i++)
            {
                ...
                tweensA[i] = LeanTween
                    .move(
                        cube,
                        cube.transform.position + new Vector3(10f, 0, 0),
                        0.5f + 1f * (1.0f / (float)aGOs.Length)
                    )
                    .id;
            ...
            for (int i = 0; i < bGOs.Length; i++)
            {
                ...
                bGOs[i] = cube;
                tweensB[i] = LeanTween
                    .move(cube, cube.transform.position + new Vector3(10f, 0, 0), 2f)
                    .id;
            }
            ...
            for (int i = 0; i < aGOs.Length; i++)
            {
                ...
                GameObject cube = aGOs[i];
                tweensA[i] = LeanTween
                    .move(cube, new Vector3(0, 0, i * 2f) + new Vector3(10f, 0, 0), 2f)
                    .id;
            }
            ...
            for (int i = 0; i < aGOs.Length; i++)
            {
                if (
                    Vector3.Distance(
                        aGOs[i].transform.position,
                        new Vector3(0, 0, i * 2f) + new Vector3(10f, 0, 0)
                    ) > 0.1f
                )
                    inFinalPlace = false;
            }
        ...
        void rotateRepeatAllFinished()
        {
            LeanTest.expect(
                rotateRepeatAngle == 3,
                "ROTATE AROUND MULTIPLE",
                "expected 3 times received " + rotateRepeatAngle + " times"
            );
            LeanTest.expect(
                rotateRepeat == 3,
                "ROTATE REPEAT",
                "expected 3 times received " + rotateRepeat + " times"
            );
