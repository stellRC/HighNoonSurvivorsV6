...
public class Testing240 : MonoBehaviour
{
    ...
    {
        LeanTween
            .moveY(cube1, cube1.transform.position.y - 15.0f, 10f)
        ...
        LeanTween
            .rotateAround(cube1, Vector3.forward, 360.0f, 10f)
            .setOnComplete(() =>
            {
        ...
        LeanTween
            .value(gameObject, ScaleGroundColor, new Color(1f, 0f, 0f, 0.2f), Color.blue, 2f)
            .setEaseInOutBounce();
        ...
        LeanTween.moveSplineLocal(sprite2, path, 4f).setOrientToPath2d(true).setRepeat(-1);
